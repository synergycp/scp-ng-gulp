...
function createVersions() {
  return gulpsync.sync(['public-manifest', 'implement-public-manifest', 'js-css-manifest', 'replace-js-css']);
}
...
gulp.task('public-manifest', function () {
  ...
  return gulp
    .src(["!./public/index.html", "!./public/app/css/*.css", "!./public/app/js/*.js", "./public/**/*.*"])
...
gulp.task('implement-public-manifest', ['public-manifest'], function () {
  ...
  return gulp.src(['./public/files-versions-manifest.js', build.scripts + '/app.js'])
    .pipe($.concat(build.scripts + '/app.js'))
    .pipe(gulp.dest('./', { overwrite: true }));
})

gulp.task('js-css-manifest', ['implement-public-manifest'], function () {
...
gulp.task('replace-js-css', ['js-css-manifest'], function () {
  return gulp.src(["./public/index.html"])
    .pipe($.revReplace({ manifest: gulp.src("./public/index-files-versions-manifest.json") }))
